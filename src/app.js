...
// as some of these functions can be damaging if run accidentally or if run
// using the wrong API key
async function main() {
  listAllAssistants();
  // createAssistant("You are an assistant that answers questions people ask surrounding the results to a survey.");
  // deleteAllAssistants();
}
...
async function createAssistant(instructions) {
  const myAssistant = await openai.beta.assistants.create({
    ...
    name: "Helpful Assistant",                    // Arbitrary assistant name
